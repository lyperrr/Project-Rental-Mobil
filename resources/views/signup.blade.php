    ...
    <main class="py-10 pt-4 sm:pt-10">
        <div class="container">
            <div class="title text-white bg-cover flex justify-center items-center h-70 w-full bg-center rounded-xl"
                ...
                {{ __('messages.title.register_now') }}
            </div>
                ...
                <form accept="" class="p-4 sm:p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 sm:gap-8">
                        ...
                        <aside class="flex flex-col gap-4">
                            ...
                            <div class="">
                                <label for=""
                                    class="font-medium text-base mb-1">{{ __('messages.form.name.first_name') }}</label>
                                <div class="relative group">
                                    <input type="text" name="" id="" required
                                        placeholder="{{ __('messages.form.placeholder.first_name') }}"
                            ...
                            <div class="">
                                <label for=""
                                    class="font-medium text-base mb-1">{{ __('messages.form.name.last_name') }}</label>
                                <div class="relative group">
                                    <input type="text" name="" id="" required
                                        placeholder="{{ __('messages.form.placeholder.last_name') }}"
                                        class="border-2 border-shark-950/80 p-2 px-4 rounded-lg focus:border-orange-300 w-full focus:outline-none">
                                    <i
                                        class='bx bx-user absolute right-2 top-1/2 -translate-y-1/2 text-2xl text-shark-950/80 group-focus-within:text-orange-300'></i>
                                </div>
                            ...
                            <div class="">
                                <label for=""
                                    class="font-medium text-base mb-1">{{ __('messages.form.email') }}</label>
                                <div class="relative group">
                                    <input type="email" name="" id="" required
                                        placeholder="{{ __('messages.form.placeholder.email') }}"
                                        class="border-2 border-shark-950/80 p-2 px-4 rounded-lg focus:border-orange-300 w-full focus:outline-none">
                                    <i
                            ...
                            <div class="">
                                <label for=""
                                    class="font-medium text-base mb-1">{{ __('messages.form.password') }}</label>
                                <div class="relative group">
                                    <input type="password" name="" id="" required
                                        placeholder="{{ __('messages.form.placeholder.password') }}"
                                        class="border-2 border-shark-950/80 p-2 px-4 rounded-lg focus:border-orange-300 w-full focus:outline-none">
                                    <i
                            ...
                            <div class="">
                                <label for=""
                                    class="font-medium text-base mb-1">{{ __('messages.form.confirm_password') }}</label>
                                <div class="relative group">
                                    <input type="password" name="" id="" required
                                        placeholder="{{ __('messages.form.placeholder.confirm_password') }}"
                                        class="border-2 border-shark-950/80 p-2 px-4 rounded-lg focus:border-orange-300 w-full focus:outline-none">
                                    <i
                                        class='bx bx-lock-alt absolute right-2 top-1/2 -translate-y-1/2 text-2xl text-shark-950/80 group-focus-within:text-orange-300'></i>
                                </div>
                        ...
                        <aside class="flex flex-col gap-4 mt-4 sm:m-0">
                            ...
                            <div class="">
                                <label for=""
                                    class="font-medium text-base mb-1">{{ __('messages.form.phone_number') }}</label>
                                <div class="relative group">
                                    <input type="number" name="" id="" required pattern="[0-9]+" minlength="10" maxlength="15"
                                        placeholder="{{ __('messages.form.placeholder.phone_number') }}"
                            ...
                            <div class="">
                                <label for=""
                                    class="font-medium text-base mb-1">{{ __('messages.form.card.resident_identity_card') }}</label>
                                <div class="relative group">
                                    <input type="number" name="" id="" required
                                        placeholder="{{ __('messages.form.placeholder.resident_identity_card') }}"
                                        class="border-2 border-shark-950/80 p-2 px-4 rounded-lg focus:border-orange-300 w-full focus:outline-none appearance-none [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none [&-moz-appearance:textfield]">
                                    <i
                            ...
                            <div class="">
                                <label for=""
                                    class="font-medium text-base mb-1">{{ __('messages.form.card.driver_license') }}</label>
                                <div class="relative group">
                                    <input type="number" name="" id="" required
                                        placeholder="{{ __('messages.form.placeholder.driver_license') }}"
                                        class="border-2 border-shark-950/80 p-2 px-4 rounded-lg focus:border-orange-300 w-full focus:outline-none appearance-none [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none [&-moz-appearance:textfield]">
                                    <i
                                        class='bx bx-id-card absolute right-2 top-1/2 -translate-y-1/2 text-2xl text-shark-950/80 group-focus-within:text-orange-300'></i>
                                </div>
                            ...
                            <div class="">
                                <label for=""
                                    class="font-medium text-base mb-1">{{ __('messages.form.card.photo_of_resident_identity_card') }}</label>
                                <div class="relative group">
                            ...
                            <div class="">
                                <label for=""
                                    class="font-medium text-base mb-1">{{ __('messages.form.card.photo_of_driver_license') }}</label>
                                <div class="relative group">
                                    <input type="file" name="" id="" required
                                        class="border-dashed border-2 border-shark-950/80 p-2 px-4 rounded-lg focus:border-orange-300 w-full focus:outline-none">
                                    <i
                    ...
                    <div class="col-span-2 mt-4">
                        <label for=""
                            class="font-medium text-base mb-1">{{ __('messages.form.address') }}</label>
                        <div class="relative group">
                            <textarea placeholder="{{ __('messages.form.address') }}" name="" id="" rows="5" required
                    ...
                    <p class="text-center mt-4">{{ __('messages.form.already_have_account') }}
